    ...
    "events": [
        {
            ...
            "description": "[Thomas Bayes]<br>发展逆概率思想，奠定贝叶斯推断基础。"
        },
        {
            "start": "1835",
            "title": "George Boole（1815–1864）",
            "description": "[George Boole]<br>创立代数逻辑，为数字计算与符号推理奠基。"
        },
        {
            "start": "1914",
            "title": "Norbert Wiener（1894–1964）",
            "description": "[Norbert Wiener]<br>创立控制论，连接反馈、控制、通信与学习。"
        },
        {
            "start": "1918",
            "title": "Warren McCulloch（1898–1969）",
            "description": "[Warren McCulloch]<br>共同创建最早具有影响力的神经计算数学模型。"
        },
        {
            "start": "1921",
            "title": "Arthur Samuel（1901–1990）",
            "description": "[Arthur Samuel]<br>开创自学习博弈程序与实用机器学习。"
        },
        {
            "start": "1923",
            "title": "John von Neumann（1903–1957）",
            "description": "[John von Neumann]<br>深刻影响存储程序计算、博弈论与智能机器的数学架构。"
        },
        {
            "start": "1924",
            "title": "Donald Hebb（1904–1985）",
            "description": "[Donald Hebb]<br>提出突触学习原理，启发连接主义学习规则。"
        },
        {
            "start": "1930",
            "title": "Margaret Masterman（1910–1986）",
            "description": "[Margaret Masterman]<br>推动计算语言学、语义网络与早期机器翻译。"
        },
        {
            "start": "1932",
            "title": "Alan Turing（1912–1954）",
            "description": "[Alan Turing]<br>定义计算，提出机器智能测试，奠定人工智能概念基础。"
        },
        {
            "start": "1936",
            "title": "Claude Shannon（1916–2001）",
            "description": "[Claude Shannon]<br>创立信息论，并将逻辑与搜索思想用于机器和博弈。"
        },
        {
            "start": "1936",
            "title": "Herbert A. Simon（1916–2001）",
            "description": "[Herbert A. Simon]<br>共同创建符号问题求解，并发展有限理性理论。"
        },
        {
            "start": "1941",
            "title": "Lotfi A. Zadeh（1921–2017）",
            "description": "[Lotfi A. Zadeh]<br>创立模糊集合理论与近似推理。"
        },
        {
            "start": "1943",
            "title": "Walter Pitts（1923–1969）",
            "description": "[Walter Pitts]<br>共同提出连接大脑与计算的逻辑神经元模型。"
        },
        {
            "start": "1947",
            "title": "John McCarthy（1927–2011）",
            "description": "[John McCarthy]<br>提出“人工智能”名称，创建Lisp并塑造符号人工智能。"
        },
        {
            "start": "1947",
            "title": "Marvin Minsky（1927–2016）",
            "description": "[Marvin Minsky]<br>共同创立MIT人工智能实验室，为符号与神经人工智能作出基础贡献。"
        },
        {
            "start": "1947",
            "title": "Allen Newell（1927–1992）",
            "description": "[Allen Newell]<br>共同创建逻辑理论家与通用问题求解器，并推动认知科学形成。"
        },
        {
            "start": "1948",
            "title": "Frank Rosenblatt（1928–1971）",
            "description": "[Frank Rosenblatt]<br>发明感知机与早期可训练神经学习规则。"
        },
        {
            "start": "1948",
            "title": "Leo Breiman（1928–2005）",
            "description": "[Leo Breiman]<br>发展CART、Bagging与随机森林，倡导预测算法建模。"
        },
        {
            "start": "1953",
            "title": "Nils J. Nilsson（1933–2019）",
            "description": "[Nils J. Nilsson]<br>推动搜索、规划、机器人与智能体架构发展。"
        },
        {
            "start": "1955",
            "title": "Karen Spärck Jones（1935–2007）",
            "description": "[Karen Spärck Jones]<br>开创信息检索、逆文档频率与自然语言处理。"
        },
        {
            "start": "1956",
            "title": "Edward Feigenbaum（1936–2021）",
            "description": "[Edward Feigenbaum]<br>领导专家系统研究与知识工程运动。"
        },
        {
            "start": "1956",
            "title": "Judea Pearl（1936–）",
            "description": "[Judea Pearl]<br>创建现代贝叶斯网络并改变因果推断。"
        },
        {
            "start": "1956",
            "title": "Vladimir Vapnik（1936–）",
            "description": "[Vladimir Vapnik]<br>共同发展统计学习理论、VC维与支持向量机。"
        },
        {
            "start": "1962",
            "title": "David Rumelhart（1942–2011）",
            "description": "[David Rumelhart]<br>推动反向传播与分布式表示在认知建模中普及。"
        },
        {
            "start": "1963",
            "title": "J. Ross Quinlan（1943–）",
            "description": "[J. Ross Quinlan]<br>创建ID3、C4.5等有影响力的决策树学习方法。"
        },
        {
            "start": "1967",
            "title": "Geoffrey Hinton（1947–）",
            "description": "[Geoffrey Hinton]<br>推动反向传播、分布式表示、玻尔兹曼机与深度学习复兴。"
        },
        {
            "start": "1968",
            "title": "Andrew Barto（1948–）",
            "description": "[Andrew Barto]<br>共同发展Actor–Critic与现代强化学习基础。"
        },
        {
            "start": "1968",
            "title": "Barbara Grosz（1948–）",
            "description": "[Barbara Grosz]<br>开创话语建模、协作智能体与负责任人工智能机构建设。"
        },
        {
            "start": "1969",
            "title": "Leslie Valiant（1949–）",
            "description": "[Leslie Valiant]<br>创立PAC学习理论，在计算学习与复杂性方面作出重要成果。"
        },
        {
            "start": "1971",
            "title": "Tom M. Mitchell（1951–）",
            "description": "[Tom M. Mitchell]<br>推动归纳学习形式化，并以基础机器学习教材培养多代研究者。"
        },
        {
            "start": "1974",
            "title": "Rodney Brooks（1954–）",
            "description": "[Rodney Brooks]<br>开创行为式机器人，并挑战纯符号智能路线。"
        },
        {
            "start": "1976",
            "title": "Michael I. Jordan（1956–）",
            "description": "[Michael I. Jordan]<br>塑造概率机器学习、变分推断与人工智能统计基础。"
        },
        {
            "start": "1976",
            "title": "Peter Norvig（1956–）",
            "description": "[Peter Norvig]<br>推动人工智能教育、概率自然语言处理与大规模智能系统。"
        },
        {
            "start": "1977",
            "title": "Richard S. Sutton（1957–）",
            "description": "[Richard S. Sutton]<br>发展时序差分学习，并统一现代强化学习理论。"
        },
        {
            "start": "1980",
            "title": "Yann LeCun（1960–）",
            "description": "[Yann LeCun]<br>开创卷积神经网络与现代表示学习。"
        },
        {
            "start": "1982",
            "title": "Stuart Russell（1962–）",
            "description": "[Stuart Russell]<br>推动理性智能体理论、概率人工智能与有益人工智能研究。"
        },
        {
            "start": "1982",
            "title": "Rosalind Picard（1962–）",
            "description": "[Rosalind Picard]<br>创立情感计算，开拓机器识别人类情绪的研究。"
        },
        {
            "start": "1983",
            "title": "Jürgen Schmidhuber（1963–）",
            "description": "[Jürgen Schmidhuber]<br>推动循环网络、LSTM时代研究、压缩与自我改进智能体。"
        },
        {
            "start": "1984",
            "title": "Yoshua Bengio（1964–）",
            "description": "[Yoshua Bengio]<br>开创神经语言模型、表示学习与深度学习。"
        },
        {
            "start": "1987",
            "title": "Sepp Hochreiter（1967–）",
            "description": "[Sepp Hochreiter]<br>分析梯度消失并共同发明LSTM。"
        },
        {
            "start": "1987",
            "title": "Sebastian Thrun（1967–）",
            "description": "[Sebastian Thrun]<br>推动概率机器人、自动驾驶与大规模在线人工智能教育。"
        },
        {
            "start": "1987",
            "title": "Cynthia Breazeal（1967–）",
            "description": "[Cynthia Breazeal]<br>开创社交机器人与人机交互。"
        },
        {
            "start": "1988",
            "title": "Daphne Koller（1968–）",
            "description": "[Daphne Koller]<br>推动概率图模型、计算生物学与在线教育。"
        },
        {
            "start": "1988",
            "title": "Jeff Dean（1968–）",
            "description": "[Jeff Dean]<br>在Google领导大规模机器学习系统、深度学习基础设施与模型项目。"
        },
        {
            "start": "1990",
            "title": "Regina Barzilay（1970–）",
            "description": "[Regina Barzilay]<br>推动自然语言处理及面向医学与科学发现的机器学习。"
        },
        {
            "start": "1994",
            "title": "Kate Crawford（1974–）",
            "description": "[Kate Crawford]<br>分析人工智能背后的社会、政治、劳动与环境系统。"
        },
        {
            "start": "1996",
            "title": "Fei-Fei Li（1976–）",
            "description": "[Fei-Fei Li]<br>创建ImageNet，推动计算机视觉、具身智能与以人为中心的人工智能。"
        },
        {
            "start": "1996",
            "title": "Andrew Ng（1976–）",
            "description": "[Andrew Ng]<br>推动深度学习、大规模人工智能教育与工业机器学习实践。"
        },
        {
            "start": "1996",
            "title": "Demis Hassabis（1976–）",
            "description": "[Demis Hassabis]<br>共同创立DeepMind，并领导AlphaGo、AlphaFold等突破。"
        },
        {
            "start": "1996",
            "title": "David Silver（1976–）",
            "description": "[David Silver]<br>领导从AlphaGo到AlphaZero、MuZero的重要强化学习突破。"
        },
        {
            "start": "1996",
            "title": "Cynthia Rudin（1976–）",
            "description": "[Cynthia Rudin]<br>推动可解释机器学习，并倡导高风险决策使用透明模型。"
        },
        {
            "start": "1997",
            "title": "Pieter Abbeel（1977–）",
            "description": "[Pieter Abbeel]<br>推动机器人学习、模仿学习与深度强化学习。"
        },
        {
            "start": "2001",
            "title": "Alex Graves（1981–）",
            "description": "[Alex Graves]<br>发展CTC及面向语音与序列学习的重要循环网络方法。"
        },
        {
            "start": "2002",
            "title": "Anima Anandkumar（1982–）",
            "description": "[Anima Anandkumar]<br>推动张量方法、深度学习、科学人工智能与可扩展机器学习系统。"
        },
        {
            "start": "2003",
            "title": "Timnit Gebru（1983–）",
            "description": "[Timnit Gebru]<br>推动计算机视觉及数据集偏差、模型文档与人工智能问责研究。"
        },
        {
            "start": "2003",
            "title": "Dario Amodei（1983–）",
            "description": "[Dario Amodei]<br>领导前沿语言模型开发，并共同创立强调安全与对齐的Anthropic。"
        },
        {
            "start": "2004",
            "title": "Kaiming He（1984–）",
            "description": "[Kaiming He]<br>创建残差网络，并推动视觉表示学习与检测重大进步。"
        },
        {
            "start": "2005",
            "title": "Ian Goodfellow（1985–）",
            "description": "[Ian Goodfellow]<br>发明生成对抗网络，并推动深度学习安全与表示学习。"
        },
        {
            "start": "2005",
            "title": "Sam Altman（1985–）",
            "description": "[Sam Altman]<br>在ChatGPT及后续前沿模型大规模部署时期领导OpenAI。"
        },
        {
            "start": "2006",
            "title": "Ilya Sutskever（1986–）",
            "description": "[Ilya Sutskever]<br>共同创建AlexNet、序列到序列学习，并推动重要大语言模型项目。"
        },
        {
            "start": "2006",
            "title": "Alex Krizhevsky（1986–）",
            "description": "[Alex Krizhevsky]<br>构建AlexNet，展示GPU训练卷积视觉模型的决定性表现。"
        },
        {
            "start": "2006",
            "title": "Andrej Karpathy（1986–）",
            "description": "[Andrej Karpathy]<br>推动卷积视觉、神经语言建模、自动驾驶人工智能与实践教育。"
        },
        {
            "start": "2007",
            "title": "Sergey Levine（1987–）",
            "description": "[Sergey Levine]<br>推动深度强化学习、机器人学习与通用控制策略。"
        },
        {
            "start": "2009",
            "title": "Joy Buolamwini（1989–）",
            "description": "[Joy Buolamwini]<br>揭示商业人脸分析的人口偏差，并创建算法正义倡议。"
        },
        {
            "start": "2012",
            "title": "Chelsea Finn（1992–）",
            "description": "[Chelsea Finn]<br>推动元学习、机器人学习及智能体少量经验适应方法。"
        }
    ]
};
