...
var init_date = "Jun 28 1900 00:00:00 GMT";
...
function tl_init() {
    ...
    // the last band, which starts at 50px per year (500px per decade), so the
    // scale bar opens at "2 years"; bands 1 and 2 are 50x and 2.5x finer.
    var bandInfos = [
        // Band 1
